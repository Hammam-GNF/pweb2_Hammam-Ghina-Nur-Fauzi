                      ...
                      <form action="{{ route('insert-siswa') }}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" name="nama_siswa" class="form-control" required id="basic-icon-default-fullname" placeholder="contoh : Hammam Ghina Nur Fauzi" aria-label="" aria-describedby="basic-icon-default-fullname2" >
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="number" name="nis" id="basic-icon-default-company" class="form-control" required placeholder="contoh : 12345" aria-label="" aria-describedby="basic-icon-default-company2">
                          </div>
                        </div>
